...
$profesorList = $profesorModel->obtenerPorColegio($colegioId);
$profesor  = isset($profesorList[0]) ? trim(($profesorList[0]['apellidos'] ?? '').' '.($profesorList[0]['nombres'] ?? '')) : "No asignado";
...
if (!empty($fichas)) {
    ...
    // Recolectar aprendices por todas las fichas del colegio
