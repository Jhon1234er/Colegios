...
<style>
  .metric { border:1px solid #e5e7eb; border-radius:12px; background:#fff; padding:16px; height:100%; box-shadow:0 2px 10px rgba(15,23,42,0.04); }
  .metric h6 { color:#6b7280; font-size:.85rem; text-transform:uppercase; letter-spacing:.04rem; margin:0 0 6px; }
  ...
  .filters .form-select, .filters .form-control[type="date"], .filters .select2-container .select2-selection--single {
    ...
    transition: box-shadow .2s ease, border-color .2s ease; min-height:42px;
  }
  .filters .form-control[type="date"] { padding: .5rem .75rem; }
  .filters .form-select:focus, .filters .form-control[type="date"]:focus, .filters .select2-container--default.select2-container--focus .select2-selection--single {
    border-color:#60a5fa; box-shadow:0 0 0 4px rgba(96,165,250,0.25);
  }
  .filters .input-group-text { border-radius:12px; background:#eef2ff; color:#374151; border:1px solid #e5e7eb; }
  .filters .btn { border-radius:12px; font-weight:600; }
  /* Select2 dropdown */
  ...
  .filters .select2-container--default .select2-selection--single .select2-selection__arrow { height:42px; right:8px; }
  .filters .select2-dropdown { border-radius:12px; box-shadow: 0 10px 24px rgba(0,0,0,0.08); border:1px solid #e5e7eb; }
  .filters .select2-results__option--highlighted { background:#f1f5f9; color:#111827; }
  .filters .select2-selection__placeholder { color:#6b7280; }
  /* jQuery UI Datepicker look & feel */
  .ui-datepicker { font-family: inherit; border-radius:12px; border:1px solid #e5e7eb; box-shadow:0 10px 24px rgba(0,0,0,0.08); padding:.5rem; }
  .ui-datepicker .ui-datepicker-header { background:#f8fafc; border:0; border-radius:10px; }
  .ui-datepicker .ui-state-default { border:0; background:#fff; text-align:center; padding:.35rem .45rem; border-radius:8px; }
  .ui-datepicker .ui-state-active { background:#0d6efd; color:#fff; }
  .ui-datepicker .ui-state-hover { background:#e5f0ff; }
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if (window.jQuery && $.fn.datepicker) {
    ...
    $('#desde').datepicker({
      onSelect: function(){ cargarResumen(); }
    });
    $('#hasta').datepicker({
      onSelect: function(){ cargarResumen(); }
    });
