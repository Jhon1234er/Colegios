...
<header>
  <div class="header-content">
    ...
    <div class="header-buttons">
      <div class="menu">
      <?php if (isset($_SESSION['usuario']['rol_id']) && $_SESSION['usuario']['rol_id'] == 1): ?>

          <div class="buscador-global-container-header">
            <form id="buscador-global" class="buscador-global-form" autocomplete="off">
              <select id="filtro-busqueda" name="filtro">
                <option value="colegio">Colegios</option>
                <option value="profesor">Facilitadores</option>
                <option value="estudiante">Aprendices</option>
              </select>
              <input type="text" id="input-busqueda" name="q" placeholder="Buscar...">
