...
?>
<link rel="stylesheet" href="/css/AreaDeConocimiento/crear.css?v=2">
...
<div class="container">
  <div class="card-widget">
    ...
    <?php else: ?>
      <form method="POST" action="?page=cursos&action=actualizar">
        <?= csrf_input(); ?>
        ...
        <div class="row" style="justify-content:flex-end;gap:12px;margin-top:20px;">
          ...
          <a href="/?page=cursos" class="btn btn-light btn-size">Cancelar</a>
        </div>
      </form>
    <?php endif; ?>
  </div>
